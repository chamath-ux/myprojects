			...
			<?php if (isset($records) && is_array($records)) {
				foreach ($records as $record) { ?>
					<tr>
						...
						<td>
							<a href="<?php echo base_url() . 'user/show/' . $record['user_id']; ?>" class="btn btn-sm btn-info btn-page-overlay">View</a>
						</td>
						<td>
							<a href="<?php echo base_url() . 'user/edit/' . $record['user_id']; ?>" class="btn btn-sm btn-warning btn-page-overlay">Edit</a>
						</td>
					</tr>
				<?php }
			} ?>
